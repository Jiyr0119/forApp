var url = baseURI,
	token;
var request = new HproseHttpClient(url+'NewSonDecoration.php', ['SelectSonTemplateForId'],{ timeout: 20000 }),
	listView = new HproseHttpClient(url+'NewDecoration.php', ['GetGoodsInfo'],{ timeout: 20000 });
